...
public class UAttributes {
	...
	public static final Attribute DIG_SPEED = register("dig_speed", new RangedAttribute( "attribute.name.unionlib.dig_speed", 1.0D, -1024.0D, 1024.0D).setShouldWatch(true));;

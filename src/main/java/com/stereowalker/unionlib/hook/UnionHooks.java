...
//	}
	...
	public static Multimap<String, AttributeModifier> adjustAttributeMap(Multimap<String, AttributeModifier> original, EquipmentSlotType equipmentSlot, ItemStack stack) {
		HashMultimap<String, AttributeModifier> modifiedMap = HashMultimap.create(original);

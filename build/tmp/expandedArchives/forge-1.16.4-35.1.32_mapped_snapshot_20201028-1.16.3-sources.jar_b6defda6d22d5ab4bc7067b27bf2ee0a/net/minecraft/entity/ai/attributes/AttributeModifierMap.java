...
public class AttributeModifierMap {
   public final Map<Attribute, ModifiableAttributeInstance> attributeMap;
   ...
   public static class MutableAttribute {
      public final Map<Attribute, ModifiableAttributeInstance> attributeMap = Maps.newHashMap();
